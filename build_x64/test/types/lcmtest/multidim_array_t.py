...
class multidim_array_t(object):
    ...
    def from_dict(self, j):
        self.size_a = j["size_a"]
        self.size_b = j["size_b"]
        self.size_c = j["size_c"]
        self.data = j["data"]
        self.strarray = j["strarray"]

    def to_dict(self):
        j = {}
        j["size_a"] = self.size_a
        j["size_b"] = self.size_b
        j["size_c"] = self.size_c
        j["data"] = self.data
        j["strarray"] = self.strarray
        return j
