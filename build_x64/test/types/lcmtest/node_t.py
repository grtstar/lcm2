...
class node_t(object):
    ...
    def from_dict(self, j):
        self.num_children = j["num_children"]
        self.children = [x.from_dict() for x in j["children"]]

    def to_dict(self):
        j = {}
        j["num_children"] = self.num_children
        j["children"] = [x.to_dict() for x in self.children]
        return j
