...
class multidim_array_t
{
    ...
    public:
        NLOHMANN_DEFINE_TYPE_INTRUSIVE(multidim_array_t, size_a, size_b, size_c, data, strarray)
#endif
    ...
    public:
        ...
        NLOHMANN_DEFINE_TYPE_INTRUSIVE_WITH_DEFAULT(multidim_array_t, size_a, size_b, size_c, data, strarray)
#endif
#ifdef __MSGPACK
    public:
        MSGPACK_DEFINE(multidim_array_t, size_a, size_b, size_c, data, strarray)
#endif
    public:
        bool operator==(const multidim_array_t& other) const
        {
            return size_a == other.size_a && size_b == other.size_b && size_c == other.size_c && data == other.data && strarray == other.strarray;
        }
    public:
        /**
