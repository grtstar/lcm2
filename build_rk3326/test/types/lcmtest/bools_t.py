...
class bools_t(object):
    ...
    def from_dict(self, j):
        self.one_bool = j["one_bool"]
        self.fixed_array = j["fixed_array"]
        self.num_a = j["num_a"]
        self.num_b = j["num_b"]
        self.one_dim_array = j["one_dim_array"]
        self.two_dim_array = j["two_dim_array"]

    def to_dict(self):
        j = {}
        j["one_bool"] = self.one_bool
        j["fixed_array"] = self.fixed_array
        j["num_a"] = self.num_a
        j["num_b"] = self.num_b
        j["one_dim_array"] = self.one_dim_array
        j["two_dim_array"] = self.two_dim_array
        return j
