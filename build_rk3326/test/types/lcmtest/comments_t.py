...
class comments_t(object):
    ...
    def from_dict(self, j):
        self.field_a = j["field_a"]
        self.field_b = j["field_b"]
        self.field_c = j["field_c"]
        self.field_d = j["field_d"]
        self.field_e = j["field_e"]
        self.array = j["array"]

    def to_dict(self):
        j = {}
        j["field_a"] = self.field_a
        j["field_b"] = self.field_b
        j["field_c"] = self.field_c
        j["field_d"] = self.field_d
        j["field_e"] = self.field_e
        j["array"] = self.array
        return j
